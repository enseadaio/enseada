...
type UsersAPI interface {
	...
	// Only callable by the user itself.
...
func NewUsersAPIProtobufClient(addr string, client HTTPClient) UsersAPI {
...
func (c *usersAPIProtobufClient) UpdateUser(ctx context.Context, in *UpdateUserRequest) (*UpdateUserResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "auth.v1beta1")
	ctx = ctxsetters.WithServiceName(ctx, "UsersAPI")
...
func NewUsersAPIJSONClient(addr string, client HTTPClient) UsersAPI {
	prefix := urlBase(addr) + UsersAPIPathPrefix
	urls := [6]string{
		prefix + "ListUsers",
		prefix + "GetUser",
...
func (c *usersAPIJSONClient) UpdateUser(ctx context.Context, in *UpdateUserRequest) (*UpdateUserResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "auth.v1beta1")
	ctx = ctxsetters.WithServiceName(ctx, "UsersAPI")
	ctx = ctxsetters.WithMethodName(ctx, "UpdateUser")
	out := new(UpdateUserResponse)
...
func (s *usersAPIServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	case "/twirp/auth.v1beta1.UsersAPI/CreateUser":
		...
		return
	case "/twirp/auth.v1beta1.UsersAPI/UpdateUser":
...
func (s *usersAPIServer) serveUpdateUser(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *usersAPIServer) serveUpdateUserJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "UpdateUser")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	func() {
		defer ensurePanicResponses(ctx, resp, s.hooks)
		respContent, err = s.UsersAPI.UpdateUser(ctx, reqContent)
	}()
...
func (s *usersAPIServer) serveUpdateUserProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "UpdateUser")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
