...
impl From<ErrorCode> for Error {
    fn from(code: ErrorCode) -> Self {
        match code {
            ...
            ErrorCode::DigestInvalid => Self::new(code, "provided digest did not match uploaded content"),
            ...
            ErrorCode::ManifestUnverified => Self::new(code, "manifest failed signature verification"),
            ...
            ErrorCode::SizeInvalid => Self::new(code, "provided length did not match content length"),
